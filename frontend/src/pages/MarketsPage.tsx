    ...
    >
      <TableCell className="px-5 py-3.5">
        <div className="flex items-center gap-3">
          {asset.imageUrl ? (
            <img src={asset.imageUrl} alt={asset.name} className="w-8 h-8 rounded-full shrink-0" />
          ) : (
            <div className="w-8 h-8 rounded-full bg-surface-2 shrink-0" />
          )}
          <div>
            <div className="text-sm font-medium text-white">{pair}</div>
      ...
      <TableCell className="px-5 py-3.5 text-right">
        <span className="flex items-center justify-end gap-1 text-xs text-accent font-medium opacity-0 group-hover:opacity-100 transition-opacity">
  ...
  return (
    <div className="h-full overflow-auto">
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-8">
          <h1 className="text-xl font-medium text-white mb-1">Markets</h1>
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-border hover:bg-transparent">
                  <TableHead className="px-5 py-3 text-[11px] font-normal text-muted uppercase tracking-wider">Market</TableHead>
                  <TableHead className="px-5 py-3 text-[11px] font-normal text-muted uppercase tracking-wider text-right">Price</TableHead>
                  <TableHead className="px-5 py-3 text-[11px] font-normal text-muted uppercase tracking-wider text-right">Bid</TableHead>
                  <TableHead className="px-5 py-3 text-[11px] font-normal text-muted uppercase tracking-wider text-right">Ask</TableHead>
                  <TableHead className="px-5 py-3 text-[11px] font-normal text-muted uppercase tracking-wider text-right">Spread</TableHead>
